...
Make sure GCC and G++ 10 is used, one way is to add on your .bashrc/.zshrc ```export CC=/usr/bin/gcc-10``` and ```export CXX=/usr/bin/gxx-10```
PopOs should be able to compile without this.
### Fedora
